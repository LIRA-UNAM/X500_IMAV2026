...
class PX4OffboardNode(Node):
    ...
    def takoff_cb(self,msg:Bool):
        ...
        if msg.data and self.start_takeoff and not self.launch_commanded:
            ...
            self.get_logger().info("Señal de despgue recibida.")
    ...
    def __init__(self):
        ...
        def spin(self):
            self.get_logger().info("INICIALIZED PX4 OFFBOARD NODE TO %d Hz" % LOOP_RATE)
            counter = 0
            state = SM_INIT
